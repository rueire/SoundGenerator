      ...
      operatorParams: [
        {
          ...
          eg_rate3: params.operatorParams[5]?.eg_rate3 ?? 28,
          eg_rate4: params.operatorParams[5]?.eg_rate4 ?? 68,
          eg_level1: params.operatorParams[5]?.eg_level1 ?? 98,
          eg_level2: params.operatorParams[5]?.eg_level2 ?? 98,
          eg_level3: params.operatorParams[5]?.eg_level3 ?? 91,
          eg_level4: params.operatorParams[5]?.eg_level4 ?? 0,
...

        {
          ...
          eg_rate3: params.operatorParams[4]?.eg_rate3 ?? 41,
          eg_rate4: params.operatorParams[4]?.eg_rate4 ?? 71,
          eg_level1: params.operatorParams[4]?.eg_level1 ?? 99,
          eg_level2: params.operatorParams[4]?.eg_level2 ?? 98,
          eg_level3: params.operatorParams[4]?.eg_level3 ?? 98,
          eg_level4: params.operatorParams[4]?.eg_level4 ?? 0,
          key_scaling_break: 39,
...

        {
          ...
          eg_rate3: params.operatorParams[3]?.eg_rate3 ?? 41,
          eg_rate4: params.operatorParams[3]?.eg_rate4 ?? 71,
          eg_level1: params.operatorParams[3]?.eg_level1 ?? 99,
          eg_level2: params.operatorParams[3]?.eg_level2 ?? 98,
          eg_level3: params.operatorParams[3]?.eg_level3 ?? 98,
          eg_level4: params.operatorParams[3]?.eg_level4 ?? 0,
          key_scaling_break: 39,
          key_scaling_left_depth: 0,
          key_scaling_right_depth: 0,
          key_scaling_left_curve: 3,
...

        {
          ...
          eg_rate3: params.operatorParams[2]?.eg_rate3 ?? 82,
          eg_rate4: params.operatorParams[2]?.eg_rate4 ?? 71,
          eg_level1: params.operatorParams[2]?.eg_level1 ?? 99,
          eg_level2: params.operatorParams[2]?.eg_level2 ?? 98,
          eg_level3: params.operatorParams[2]?.eg_level3 ?? 98,
          eg_level4: params.operatorParams[2]?.eg_level4 ?? 0,
          key_scaling_break: 39,
          key_scaling_left_depth: 0,
          key_scaling_right_depth: 0,
          key_scaling_left_curve: 3,
...

        {
          ...
          eg_rate3: params.operatorParams[1]?.eg_rate3 ?? 29,
          eg_rate4: params.operatorParams[1]?.eg_rate4 ?? 71,
          eg_level1: params.operatorParams[1]?.eg_level1 ?? 82,
          eg_level2: params.operatorParams[1]?.eg_level2 ?? 95,
          eg_level3: params.operatorParams[1]?.eg_level3 ?? 96,
          eg_level4: params.operatorParams[1]?.eg_level4 ?? 0,
        ...
        },
        {
          ...
          eg_rate3: params.operatorParams[0]?.eg_rate3 ?? 99,
          eg_rate4: params.operatorParams[0]?.eg_rate4 ?? 71,
          eg_level1: params.operatorParams[0]?.eg_level1 ?? 99,
          eg_level2: params.operatorParams[0]?.eg_level2 ?? 88,
          eg_level3: params.operatorParams[0]?.eg_level3 ?? 96,
          eg_level4: params.operatorParams[0]?.eg_level4 ?? 0,
          key_scaling_break: 39,
          key_scaling_left_depth: 0,
